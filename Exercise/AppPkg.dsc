...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/Exercise
...
[Components]
  Exercise\UEFI-6.2\UEFI-6.2.inf
  Exercise\UEFI-6.5\UEFI-6.5.inf
...
#### Sample Applications.
#  Sample\AppPkg/Applications/Hello/Hello.inf        # No LibC includes or functions.
#  Sample\AppPkg/Applications/Main/Main.inf          # Simple invocation. No other LibC functions.
#  Sample\AppPkg/Applications/Enquire/Enquire.inf
#  Sample\AppPkg\Applications\HelloX\HelloX.inf
#  Sample\AppPkg\Applications\MainX\MainX.inf
