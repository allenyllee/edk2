...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF479E147, 0xA125, 0x11d4, {0xBC, 0xFC, 0x00, 0x80, 0xC7, 0x3C, 0x88, 0x81}};
...
{
  return InitializeWinNtBlockIo (ImageHandle, SystemTable);
}
