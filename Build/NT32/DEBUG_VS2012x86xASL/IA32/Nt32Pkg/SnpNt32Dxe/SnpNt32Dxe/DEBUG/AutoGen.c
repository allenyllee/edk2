...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD0893F05, 0xB06D, 0x4161, {0xB9, 0x47, 0x9B, 0xE9, 0xB8, 0x5A, 0xC3, 0xA1}};
...
{
  return InitializeSnpNt32Driver (ImageHandle, SystemTable);
}
...
{
  return SnpNt32Unload (ImageHandle);
}
