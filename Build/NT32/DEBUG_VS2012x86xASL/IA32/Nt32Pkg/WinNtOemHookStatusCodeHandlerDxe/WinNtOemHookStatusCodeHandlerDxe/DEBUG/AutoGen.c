...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xCA4233AD, 0x847E, 0x4E5D, {0xAD, 0x3F, 0x21, 0xCA, 0xBF, 0xE5, 0xE2, 0x3C}};
...
{
  return WinNtOemHookStatusCodeHandlerDxeEntry (ImageHandle, SystemTable);
}
