...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6B41B553, 0xA649, 0x11d4, {0xBD, 0x02, 0x00, 0x80, 0xC7, 0x3C, 0x88, 0x81}};
...
{
  return InitializeWinNtSerialIo (ImageHandle, SystemTable);
}
