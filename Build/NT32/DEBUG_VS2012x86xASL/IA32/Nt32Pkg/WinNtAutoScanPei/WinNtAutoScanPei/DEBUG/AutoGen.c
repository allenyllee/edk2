...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBE0FEABA, 0x3443, 0x4919, {0x9F, 0x3A, 0x2D, 0x42, 0x16, 0x32, 0x9E, 0xA9}};
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPeiNtAutoScanPpiGuid = { 0x0dce384d, 0x007c, 0x4ba5, { 0x94, 0xbd, 0x0f, 0x6e, 0xb6, 0x4d, 0x2a, 0xa9 }};
...
{
  return PeimInitializeWinNtAutoScan (FileHandle, PeiServices);
}
