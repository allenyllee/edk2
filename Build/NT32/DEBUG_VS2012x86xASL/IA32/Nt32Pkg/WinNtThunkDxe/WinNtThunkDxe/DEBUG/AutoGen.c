...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0C95A916, 0xA006, 0x11d4, {0xBC, 0xFA, 0x00, 0x80, 0xC7, 0x3C, 0x88, 0x81}};
...
{
  return InitializeWinNtThunk (ImageHandle, SystemTable);
}
