...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x29b3c4c6, 0xe5aa, 0x49e4, {0x8c, 0xe0, 0x27, 0x72, 0xf7, 0x82, 0xdd, 0xc2}};
...
{
  return InitializeWinNtGop (ImageHandle, SystemTable);
}
