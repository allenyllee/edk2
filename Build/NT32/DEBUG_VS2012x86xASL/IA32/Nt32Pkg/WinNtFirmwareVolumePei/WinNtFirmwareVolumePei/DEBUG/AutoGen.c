...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF0384FFD, 0x8633, 0x452f, {0x90, 0x10, 0xF6, 0xB7, 0xD2, 0xEA, 0xE2, 0xF1}};
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gNtFwhPpiGuid = { 0x4e76928f, 0x50ad, 0x4334, {0xb0, 0x6b, 0xa8, 0x42, 0x13, 0x10, 0x8a, 0x57 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdWinNtFlashFvRecoveryBase = _PCD_VALUE_PcdWinNtFlashFvRecoveryBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdWinNtFlashFvRecoverySize = _PCD_VALUE_PcdWinNtFlashFvRecoverySize;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdWinNtFlashNvStorageEventLogBase = _PCD_VALUE_PcdWinNtFlashNvStorageEventLogBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdWinNtFlashNvStorageEventLogSize = _PCD_VALUE_PcdWinNtFlashNvStorageEventLogSize;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdWinNtFlashNvStorageVariableBase = _PCD_VALUE_PcdWinNtFlashNvStorageVariableBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdWinNtFlashNvStorageFtwSpareBase = _PCD_VALUE_PcdWinNtFlashNvStorageFtwSpareBase;
...
{
  return PeimInitializeWinNtFwh (FileHandle, PeiServices);
}
