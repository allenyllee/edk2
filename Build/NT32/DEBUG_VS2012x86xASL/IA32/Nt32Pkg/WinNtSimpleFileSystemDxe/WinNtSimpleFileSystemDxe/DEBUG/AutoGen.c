...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9C25E18B, 0x76BA, 0x43da, {0xA1, 0x32, 0xDB, 0xB0, 0x99, 0x7C, 0xEF, 0xEF}};
...
{
  return InitializeWinNtSimpleFileSystem (ImageHandle, SystemTable);
}
