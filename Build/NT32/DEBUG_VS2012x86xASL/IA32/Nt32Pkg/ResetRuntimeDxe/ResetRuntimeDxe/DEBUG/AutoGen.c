...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBA929954, 0x35B0, 0x4dd3, {0x90, 0xCD, 0x96, 0x34, 0xBD, 0x7E, 0x1C, 0xF1}};
...
{
  return InitializeNtReset (ImageHandle, SystemTable);
}
