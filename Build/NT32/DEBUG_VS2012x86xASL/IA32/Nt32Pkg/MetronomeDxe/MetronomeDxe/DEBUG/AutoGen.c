...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x154CAB4A, 0x52B5, 0x46CD, {0x99, 0xC3, 0x43, 0x68, 0xAB, 0xBA, 0xCF, 0xFD}};
...
{
  return WinNtMetronomeDriverInitialize (ImageHandle, SystemTable);
}
