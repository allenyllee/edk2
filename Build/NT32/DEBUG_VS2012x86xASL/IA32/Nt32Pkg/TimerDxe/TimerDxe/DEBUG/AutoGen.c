...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC3811036, 0x710B, 0x4E39, {0x8C, 0xF1, 0x0A, 0xF9, 0xBE, 0x3A, 0x81, 0x98}};
...
{
  return WinNtTimerDriverInitialize (ImageHandle, SystemTable);
}
