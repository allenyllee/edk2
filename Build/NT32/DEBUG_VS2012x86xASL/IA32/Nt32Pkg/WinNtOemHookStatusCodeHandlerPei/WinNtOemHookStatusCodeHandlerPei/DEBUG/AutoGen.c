...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD233D6BD, 0xF1B1, 0x425A, {0xBF, 0x45, 0x5C, 0xAF, 0x2B, 0x88, 0xED, 0xDC}};
...
{
  return WinNtOemHookStatusCodeHandlerPeiEntry (FileHandle, PeiServices);
}
