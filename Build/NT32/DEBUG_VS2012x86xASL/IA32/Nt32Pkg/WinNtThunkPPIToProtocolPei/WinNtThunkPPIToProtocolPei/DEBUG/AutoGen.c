...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD3AAD8DC, 0x3A48, 0x46ac, {0xB1, 0xC7, 0x28, 0xA9, 0xD3, 0xCF, 0x67, 0x55}};
...
{
  return PeimInitializeWinNtThunkPPIToProtocolPeim (FileHandle, PeiServices);
}
