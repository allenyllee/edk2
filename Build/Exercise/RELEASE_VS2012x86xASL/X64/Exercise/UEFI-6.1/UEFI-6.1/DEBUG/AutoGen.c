...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x49464555, 0x362D, 0x312E, {0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20}};
...
#define _PCD_TOKEN_PcdDebugPrintErrorLevel  1U
...
#define _PCD_TOKEN_PcdDebugClearMemoryValue  6U
...
#define _PCD_TOKEN_PcdDriverDiagnosticsDisable  9U
...
#define _PCD_TOKEN_PcdComponentName2Disable  12U
...
#define _PCD_TOKEN_PcdUgaConsumeSupport  13U
...
#define _PCD_TOKEN_PcdUefiLibMaxPrintBufferSize  14U
...
{
  return UefiImageEntryPoint (ImageHandle, SystemTable);
}
